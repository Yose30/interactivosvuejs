    ...
    <div>
      ...
      <div id="divContent" class="container">
        ...
        <p class="instrucciones">
          <!-- <span class="numeracion-multimedia">  <font-awesome-icon icon="music"  /> </span> -->
            <b class="numero-vineta">1. </b>Look at the picture and identify the objects. What happened? Read the conversation and match the people with their possessions.
        </p>
        <div class="row">
        <div class="col-md-9">
